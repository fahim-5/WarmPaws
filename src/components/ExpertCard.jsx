        ...
        <div className="relative h-64 overflow-hidden">
          ...
          <div className="absolute top-4 right-4 bg-white bg-opacity-90 backdrop-blur-sm px-3 py-1 rounded-full">
            <div className="flex items-center text-sm font-medium text-gray-800">
              <ClockIconSVG className="w-4 h-4 mr-1 text-blue-600" />
              {expert.experience}
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="mb-4">
            ...
            <div className="flex items-center text-blue-600 font-semibold">
              <AcademicCapIconSVG className="w-4 h-4 mr-2" />
          ...
          >
            <UserIconSVG className="w-4 h-4 mr-2" />
            Book Consultation
          </motion.button>
        </div>
      </motion.div>
